...
namespace DAL
{
    public static class AccountDAL
    {
        public static bool Validate(string username,string password)
        {
            ...
            string connStr = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\CDACNotes\DotNet\EndModuleEcommApp1\ECommWebFE\App_Data\ECommDB.mdf;Integrated Security=True";
